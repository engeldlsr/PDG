      ...
      <div class="container-fluid">
        <div class="row">
          <div class="register-box-user reg_user">
            <div class="card">
              <form action="<?= base_url('administrador/reg-usuario');?>" method="post" enctype="multipart/form-data">
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <input type="text" name="apellido" class="form-control" id="apellido" placeholder="Apellidos" required="required">
                </div>
                ...
                <div class="col-6">
                    ...
                    <input type="text" name="user_login" class="form-control" id="user_login" placeholder="Nombre de usuario" required="required">
                </div>
                <div class="col-6">
                    <label for="nombre">Password:</label>
                    <input type="text" name="user_password" class="form-control" id="password" placeholder="Contrasena" required="required">
                </div>
                <div class="col-6">
                ...
                <div class="col-12 boton-registro">
                    <input type="submit" class="btn btn-sm btn-primary btn-right" value="Registrar usuario">
                    <br />
                </div>
            </form>
            </div>
