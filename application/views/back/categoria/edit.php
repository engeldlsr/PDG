      ...
      <div class="container-fluid">
        <div class="row">
          <div class="register-box-user reg_user">
            <div class="card">
            <form action="<?= base_url('administrador/categoria/update');?>" method="post">
                <div class="col-6">
                    <label for="nombre">Nombre de la categoria:</label>
                    <input type="text" name="nombre" value="<?= $categoria->nombre;?>" class="form-control" id="nombre" placeholder="Nombre" required="required">
                </div>
                <div class="col-6">
                ...
                <div><br /></div>
                    ...
                    <input type="submit" class="btn btn-sm btn-primary btn-right" value="Editar categoria">
                    <br />
                </div>
            </form>
            </div>
